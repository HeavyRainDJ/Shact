...
public class Auth : ControllerBase
{
    ...
    /// <response code="200">Регистрация успешна пройдена.</response>
    ...
    public IActionResult Register([FromBody] RegisterDto registerDto)
    {
        try
        {
            ...
            ue.Name = registerDto.Name;
            ue.Password = registerDto.Password;
            ue.Email = registerDto.Email;
            ue.Organization = registerDto.Organization;
            ue.HardSkills = registerDto.HardSkills;

            ue.Links = registerDto.Links;
            ue.Post = "";
            ue.City = "";
