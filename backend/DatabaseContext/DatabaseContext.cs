...
public sealed class Database : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().Property(d => d.IsAdmin);
        ...
        modelBuilder.Entity<Chakaton>().Property(d => d.Location);
        ...
        modelBuilder.Entity<Team>().HasOne(d => d.Chakaton).WithMany(t => t.Teams);
        ...
        modelBuilder.Entity<Request>().HasOne(d => d.Candidate).WithMany(d => d.Requests).HasForeignKey(t => t.UserId);
        modelBuilder.Entity<Request>().HasOne(d => d.Team).WithMany(d => d.Requests).HasForeignKey(t => t.TeamId);
    }
}